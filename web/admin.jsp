...
<div id="wrapper">
      ...
      <ul class="nav" id="side-menu">
            ...
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">管理员页面</strong>
                                    </span>
                                </span>
            </a>
          </div>
          <div class="logo-element">管理员页面
          </div>
        </li>
        ...
        <li>
          ...
          <ul class="nav nav-second-level">
            <li>
              <a class="J_menuItem" href="selectAllStudent.jsp">查询所有学生信息</a>
            </li>
            <li>
              <a class="J_menuItem" href="selectAllTeacher.jsp">查询所有教师信息</a>
            </li>
          </ul>
        </li>
        <li class="line dk"></li>
        <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
          <span class="ng-scope">添加功能</span>
        </li>
        <li>
          <a href="#">
            <i class="fa fa fa-edit"></i>
            <span class="nav-label">用户添加</span>
            <span class="fa arrow"></span>
          </a>
          <ul class="nav nav-second-level">
            <li>
              <a class="J_menuItem" href="insertStudent.jsp">学生用户添加</a>
            </li>
            <li>
              <a class="J_menuItem" href="insertTeacher.jsp">教师用户添加</a>
            </li>
          </ul>
        </li>
        <li class="line dk"></li>
        <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
          <span class="ng-scope">修改功能</span>
        </li>
        <li>
          <a href="#"><i class="fa fa-key"></i> <span class="nav-label">用户信息修改</span>
            <span class="fa arrow"></span></a>
          <ul class="nav nav-second-level">
            <li><a class="J_menuItem" href="updateStudent.jsp">学生信息修改</a>
            </li>
            <li><a class="J_menuItem" href="updateTeacher.jsp">教师信息修改</a>
            </li>
          </ul>
        </li>
        <li class="line dk"></li>
  ...
  <div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="row J_mainContent" id="content-main">
      <iframe id="J_iframe" width="100%" height="100%" src="selectAllStudent.jsp" frameborder="0"
