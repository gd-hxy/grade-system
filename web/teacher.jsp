...
<div id="wrapper">
      ...
      <ul class="nav" id="side-menu">
            ...
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">教师用户页面</strong>
                                    </span>
                                </span>
            </a>
          </div>
          <div class="logo-element">教师用户页面
          </div>
        </li>
        ...
        <li>
          ...
          <ul class="nav nav-second-level">
            <li>
              <a class="J_menuItem" href="avgScore.jsp">查询授课学生平均成绩</a>
            </li>
            <li>
              <a class="J_menuItem" href="teachSituation.jsp">查询任课情况</a>
            </li>
          </ul>
        </li>
        <li>
          <a href="#">
            <i class="fa fa fa-edit"></i>
            <span class="nav-label">生源地查询</span>
            <span class="fa arrow"></span>
          </a>
          <ul class="nav nav-second-level">
            <li>
  ...
  <div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="row J_mainContent" id="content-main">
      <iframe id="J_iframe" width="100%" height="100%" src="avgScore.jsp" frameborder="0" data-id="index_v1.html"
              seamless></iframe>
    </div>
  </div>
  <!--右侧部分结束-->
